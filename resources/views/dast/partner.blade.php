...
<div id="hsg-main-content" tabindex="-1"></div>
  ...
  <div style="background:rgb(1, 1, 49);border:rgb(1, 1, 51); color:white;" id="hs_cos_wrapper_module_16637605146933" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
    ...
    <div style="background:rgb(1, 1, 49);border:rgb(1, 1, 51); color:white;" id="hs_cos_wrapper_rollout_hero" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
...
<section style="background:rgb(1, 1, 49);border:rgb(1, 1, 51); color:white;" class="homepage-hero-branding-rollout" data-background="white">
    ...
    <div class="homepage-hero-branding-rollout__content">
      ...
      <div class="homepage-hero-branding-rollout__media">
          ...
          <div class="homepage-hero-branding-rollout__media-wrapper">
            <img class="homepage-hero-branding-rollout__media-image--desktop" alt="" src="https://images.unsplash.com/photo-1527689368864-3a821dbccc34?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8d2ViJTIwbGFifGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60">
            <img class="homepage-hero-branding-rollout__media-image--mobile" alt="View of a HubSpot user's weekly email, calling, and meeting activity, a contact record, and a customer service report in their HubSpot CRM platform" src="https://images.unsplash.com/photo-1527689368864-3a821dbccc34?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8d2ViJTIwbGFifGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60">
          </div>
    ...
    <div class="csol-full-width-cta-card-container cl-card -left ">
      <div class=" csol-full-width-cta-card-image">
        ...
        <div class="csol-full-width-cta-card-background">
          <img class="csol-full-width-cta-card-background-image" src="https://images.unsplash.com/photo-1502945015378-0e284ca1a5be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHdlYiUyMGxhYnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="HubSpot CMO shares predictions on AI" width="400" height="330" loading="lazy" >
        </div>
  ...
  <section id="module_16643924240403" class="csol-section csol-cta-content-block - -white -padding-top-md -padding-bottom-md">
    ...
    <div class="csol-cta-content-block-container">
      ...
      <h3 style="font-size: large;"  class="csol-cta-content-block-header"> Unlocking the Potential of Web3 Education By Leveraging Artificial Intelligence 
        ...
        <p class="csol-cta-content-block-description">Are you a forward-thinking web3 company seeking to nurture young talent, grow your global community, and drive more signups and increase your recurring monthly revenue goals seamlessly?
        </p>
...
" href="" rel="noreferrer " style="font-size: large;" >
      Contact Us Now
        ...
        </div><span class="csol-cta-content-block-disclaimer">DAST Lab offers a unique partnership opportunity that allows you to leverage our educational platform powered by ChatGPT and DAST Lab to achieve your goals.</span>
        </div>

      
        <div class="csol-cta-content-block-image">
          <img src="https://images.unsplash.com/photo-1487611459768-bd414656ea10?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHdlYiUyMGxhYnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="" loading="lazy">
        </div>
