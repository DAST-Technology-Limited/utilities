...
<link rel="stylesheet" href="https://www.hubspot.com/wt-assets/static-files/2.2.7/lp-nav/styles.css">
<link rel="stylesheet" href="https://cdn2.hubspot.net/hub/53/hub_generated/module_assets/72080961690/1687176015000/module_72080961690_WTM_-_Get_Started_-_Banner_-_Experiment.min.css">
<link rel="stylesheet" href="https://cdn2.hubspot.net/hub/53/hub_generated/module_assets/72081169593/1683744496524/module_72081169593_WTM_-_Get_Started_-_Arrow_-_Experiment.min.css">
<link rel="stylesheet" href="https://cdn2.hubspot.net/hub/53/hub_generated/module_assets/72080961693/1684400752906/module_72080961693_WTM_-_Get_Started_-_Products_-_Experiment_-_B.min.css">
...
<!-- htmlmin:ignore -->
        ...
        <script src="//cdn-3.convertexperiments.com/js/10031559-1003891.js" nonce="UN1TaH49ucwnUKGWeww+ig=="></script>
...
<link rel="stylesheet" href="https://www.hubspot.com/wt-assets/static-files/2.2.7/get-started/styles.css">
...
<!-- LangCom true -->
<a href="tel:+18884827768" class="hsg-sales-number" data-sales-number="main" aria-hidden="false" data-loaded="false">
...
<section class="get-started-header" data-background="off-white">
<div class="hsg-page-width-normal">
  <h1 class="get-started-header__header">CONTACT DAST TECHNOLOGY</h1>
  <div class="get-started-header__content">
    <div class="get-started-header__content-text">
      <p class="get-started-header__sub-header">
        Thank you for your interest in DAST Technology.
        We would love to hear from you and assist you with any inquiries or collaboration opportunities</p>
      <div class="get-started-header__ctas">
        
          <a class="get-started-header__ctas-item cl-button -large getstarted-crmdemo -primary
          " data-target-modal="variant-growth-modal" href="https://lnkd.in/deZZhAMM">
            Join Our Telegram<span class="visually-hidden">Join Our Telegram</span></a>
        
        
          <a class="get-started-header__ctas-item cl-button -large getstarted-crmfree -secondary
          " href="https://calendly.com/dominion_ndubuisi/dast-ambassadors-armies">
          Schedule a meeting<span class="visually-hidden"> Schedule a meeting</span></a>
...
<div data-modal="variant-growth-modal" data-exit="0" class="hsg-modal-container">
<div class="hsg-modal-contents">
  <button data-background="secondary4" class="hsg-modal-header">
    <span class="hsg-icon hsg-icon-close" aria-hidden="true"></span>
    <span class="visually-hidden">Close</span>
  </button>
  <div class="hsg-modal-text">
    <h3 class="hsg-modal-text--title">Schedule a meeting</h3>
...
<div id="hs_form_target_hsg-modal-form-variant-growth-modal"></div>
...
/* Example styling for the SVG icons */
.facebook-icon,
.instagram-icon,
.twitter-icon {
  width: 30px;
...
<div class="social-media-icons">
  <div class="icon-container">
    <a href="https://lnkd.in/dRtGxc6y">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
        <path d="M12 1.5c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm1.902 6.478h1.5v-2.197c0-.68.34-1.339.891-1.723.586-.41 1.346-.506 2.008-.253.657.253 1.173.871 1.33 1.559v1.25h-1.152c-1.285 0-1.549.612-1.549 1.51v1.983h2.648c.124.003.248-.005.371-.019.124-.012.245-.034.361-.064v2.186c0 .64-.29 1.258-.784 1.68-.49.418-1.164.654-1.848.654-1.457 0-2.726-1.04-3.012-2.5h-1.466v-2.187h1.466c.018-.146.04-.289.074-.429-.342-.067-.68-.167-.998-.297v2.914c.411.184.854.296 1.307.321 1.154 0 2.099-.945 2.099-2.105v-1.7c0-.305.235-.559.532-.587zm-.271 2.494h-1.5v-1.35c0-.22.137-.43.35-.506.218-.076.454-.006.62.168.153.17.239.394.239.635v1.053zm-4.68-.402h2.83c-.098-.632-.666-1.12-1.344-1.12-.68 0-1.25.49-1.345 1.12zm4.68 2.902v8.834c0 .305-.248.553-.553.553h-5.88c-.306 0-.553-.248-.553-.553v-8.834h-1.394v-3.43h1.394v-2.47c0-1.765 1.037-2.735 2.665-2.735 1.288 0 2.32.096 2.632.14v2.304h-1.794c-1.415 0-1.686.672-1.686 1.66v1.846h3.477l-.454 3.43h-3.023z"/>
      </svg>
    </a>
  </div>
  <div class="icon-container">
    <a href="https://lnkd.in/deZZhAMM">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
        <path d="M12 2c-5.513 0-10 4.486-10 10s4.487 10 10 10c5.514 0 10-4.486 10-10s-4.486-10-10-10zm3 15.5c-.244.048-.49.072-.739.072-2.938 0-5.618-2.068-6.22-5.015.409.194.87.305 1.359.305.906 0 1.731-.388 2.302-1.009-.816-.015-1.505-.553-1.738-1.288.287.055.585.034.859-.064-.925-.186-1.551-1.015-1.551-1.952v-.025c.264.146.567.235.891.245-.524-.35-1.027-.786-1.39-1.288-.191-.261-.324-.56-.383-.876.065.04.133.072.204.086-.336-.558-.526-1.2-.526-1.89 0-.416.113-.812.315-1.15 1.15 1.413 2.87 2.325 4.8 2.421-.041-.174-.063-.354-.063-.537 0-1.299 1.054-2.354 2.354-2.354.676 0 1.285.286 1.716.746.533-.104 1.033-.3 1.486-.57-.175.544-.681.94-1.28.954.591-.376.837-1.16.56-1.82.007.235-.07.464-.23.648z"/>
      </svg>
    </a>
  </div>
  <div class="icon-container">
    <a href="https://lnkd.in/dMZNbBvq">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
        <path d="M22.336 4.343c-.77.343-1.599.573-2.466.68.885-.53 1.566-1.372 1.886-2.38-.829.49-1.748.847-2.72 1.037-.78-.83-1.892-1.344-3.125-1.344-2.366 0-4.278 1.913-4.278 4.277 0 .336.038.665.112.979-3.554-.18-6.7-1.886-8.812-4.484-.37.636-.583 1.375-.583 2.165 0 1.487.757 2.797 1.905 3.555-.702-.023-1.363-.215-1.937-.538v.054c0 2.074 1.476 3.805 3.43 4.199-.36.098-.74.15-1.136.15-.277 0-.55-.027-.817-.08.552 1.73 2.154 2.996 4.055 3.033-1.487 1.166-3.357 1.857-5.375 1.857-.35 0-.697-.02-1.039-.06 1.912 1.232 4.18 1.953 6.614 1.953 7.934 0 12.26-6.561 12.26-12.26 0-.186-.003-.372-.012-.556.844-.609 1.577-1.374 2.157-2.244l-.05-.024z"/>
      </svg>
    </a>
  </div>
</div>
...
<script nonce="UN1TaH49ucwnUKGWeww+ig==">
  const arrowButton = document.querySelector('#arrow-cta');
  const downArrow = document.querySelector('#down-arrow');
  const upArrow = document.querySelector('#up-arrow');
  const displayNoneClass = 'display-none';

  const calculateScreenMidPoint = () => document.documentElement.clientHeight / 2;
  let screenMidPoint = calculateScreenMidPoint();

  const showDownArrow = () => {
    upArrow.classList.add(displayNoneClass);
    downArrow.classList.remove(displayNoneClass);
  }

  const showUpArrow = () => {
    downArrow.classList.add(displayNoneClass);
    upArrow.classList.remove(displayNoneClass);
  }
  ...
  window.addEventListener('scroll', () => {
    const isArrowOnTopHalfOfThePage = arrowButton.getBoundingClientRect().top < screenMidPoint;
    const isUpArrowHidden = upArrow.classList.contains(displayNoneClass);
    const isDownArrowHidden = downArrow.classList.contains(displayNoneClass);

    if (isArrowOnTopHalfOfThePage && isUpArrowHidden) {
      showUpArrow();
    } else if (!isArrowOnTopHalfOfThePage && isDownArrowHidden) {
      showDownArrow();
    }
  });

  window.addEventListener('resize', () => {
    screenMidPoint = calculateScreenMidPoint();
  });
</script>
</div>
</main>
...
<div id="hs_cos_wrapper_vsb_multi_form_redirect" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module"><script id="vsb-redirect-options" type="application/json" nonce="UN1TaH49ucwnUKGWeww+ig==">
  {
    "geoLocation": "ng",
    "options": {"dd3abfde-a04d-4a60-8e01-589751844027": {
          ...
          "vsbRedirectDestination": "https://offers.hubspot.com/thank-you/starter-suite-demo",
          ...
          "nonVsbRedirectDestination": "https://offers.hubspot.com/thank-you/platform-demo","customClass": "getstarted-crmdemo",
          ...
          "vsbRedirectDestination": "https://offers.hubspot.com/thank-you/starter-suite-demo",
          "vsbCountries": ["af","bd","bt","io","bn","kh","cn","cx","cc","ck","fj","pf","tf","gu","hk","id","ki","kr","kg","la","mo","my","mv","mh","fm","mn","mm","nr","np","nc","nu","nf","pk","pw","pg","ph","ws","sg","sb","lk","tw","tj","th","tl","to","tm","tv","uz","vn","ai","ag","ar","aw","bs","bb","bz","bm","bo","bq","vg","ky","cl","co","cr","cw","dm","do","ec","sv","gf","gd","gt","gy","ht","hn","in","jm","mq","mx","ms","ni","pa","py","pe","pr","bl","kn","lc","mf","vc","sx","sr","tt","tc","vi","uy","ve"],
          "nonVsbRedirectDestination": "https://offers.hubspot.com/thank-you/cms-demo","customClass": "getstarted-cmsdemo",
          "vsbCountryFieldInForm": false,
          
          "sgBookAMeetingForm": false
        },"7d10b36b-3721-4e64-bc9c-3b1780411c1e": {
          "formLabel": "Operations Hub",
          "vsbPropertyName": "employees__c",
          "vsbPropertyValues": ["1","2 to 5"],
          "vsbPropertyValueExceptions": ["6 to 10","11 to 25"],
          "vsbRedirectDestination": "https://offers.hubspot.com/thank-you/starter-suite-demo",
          ...
          "nonVsbRedirectDestination": "https://offers.hubspot.com/thank-you/oh-demo","customClass": "getstarted-opsdemo",
          "vsbCountryFieldInForm": false,
