...
<!-- isQA:   --><!doctype html><html lang="en"><head>
...
<meta property="og:title" content="DAST CHAT - Homepage">
<meta name="twitter:description" content="DAST CHAT is the worldwide leader in inbound marketing, sales, and customer service/support training.">
<meta name="twitter:title" content="DAST CHAT - Homepage">
...
<link rel="stylesheet" href="https://academy.hubspot.com/hs-fs/hub/53/hub_generated/template_assets/40719900893/1677774130637/_Web_Team_Assets/Academy/app/global.min.css">
...
<script src="https://academy.hubspot.com/wt-assets/static-files/compliance/index.js" type="text/javascript" data-gtm-id="GTM-WFZ7LR3" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>
...
<link rel="preload" href="https://53.fs1.hubspotusercontent-na1.net/hubfs/53/tools/fonts/LexendDeca-Light.woff2" as="font" crossorigin>
<link rel="preload" href="https://53.fs1.hubspotusercontent-na1.net/hubfs/53/tools/fonts/LexendDeca-Medium.woff2" as="font" crossorigin>
<link rel="preload" href="https://53.fs1.hubspotusercontent-na1.net/hubfs/53/tools/fonts/LexendDeca-SemiBold.woff2" as="font" crossorigin>
...
<style>
  ...
  .cl-button{border:1px solid;border-radius:3px;cursor:pointer;display:inline-block;font-size:1rem;font-weight:500;text-align:center;text-decoration:none;transition:background-color .15s linear,color .15s linear}.cl-button:focus-visible,.cl-button:hover{text-decoration:none}.cl-button.-disabled,.cl-button:disabled{cursor:not-allowed;opacity:.5}.cl-button.-primary{background-color:#ff5c35;border-color:transparent;color:#fff}.cl-button.-primary:focus-visible,.cl-button.-primary:hover{background-color:#ffcec2}.cl-button.-primary:active{background-color:#d44325}.cl-button.-primary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-primary{background-color:#1d0cff}.high-contrast .cl-button.-primary:focus-visible,.high-contrast .cl-button.-primary:hover{background-color:#cee2ff;color:#0c009e}.cl-button.-primaryDark{background-color:#fff;border-color:transparent;color:#2e475d}.cl-button.-primaryDark:focus-visible,.cl-button.-primaryDark:hover{background-color:#f6f9fc}.cl-button.-primaryDark:active{background-color:#eaf0f6}.cl-button.-primaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-secondary{background-color:#fff;border-color:#ff5c35;color:#ff5c35}.cl-button.-secondary:focus-visible,.cl-button.-secondary:hover{background-color:#ffebe6}.cl-button.-secondary:active{background-color:#ffebe6}.cl-button.-secondary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-secondary{background-color:#edf8ff;border-color:#180bb1;color:#180bb1}.high-contrast .cl-button.-secondary:focus-visible,.high-contrast .cl-button.-secondary:hover{background-color:#caebff;border-color:#180bb1;color:#180bb1}.cl-button.-secondaryDark{background-color:transparent;border-color:#fff;color:#fff}.cl-button.-secondaryDark:focus-visible,.cl-button.-secondaryDark:hover{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:active{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-tertiary{background-color:#3e5974;border-color:#3e5974;color:#fff}.cl-button.-tertiary:focus-visible,.cl-button.-tertiary:hover{background-color:#516f90}.cl-button.-tertiary:active{background-color:#2e475d}.cl-button.-tertiary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.cl-button.-tertiaryDark{background-color:#eaf0f6;border-color:#b6c7d6;color:#516f90}.cl-button.-tertiaryDark:focus-visible,.cl-button.-tertiaryDark:hover{background-color:#f6f9fc;border-color:#b6c7d6}.cl-button.-tertiaryDark:active{background-color:#b6c7d6;border-color:#7691ad}.cl-button.-tertiaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-small{font-size:.875rem;line-height:1.57;padding:.25rem 1rem}.cl-button.-medium,.cl-button.-regular{font-size:1rem;line-height:1.75;padding:.5rem 2rem}.cl-button.-large{font-size:1.125rem;line-height:1.78;padding:1rem 2.5rem}.home-customers{padding-top:100px}@media(max-width:767px){.home-customers{padding:50px 0 0}}@media(min-width:768px){.home-customers__content-wrapper{align-items:center;display:flex;flex-flow:row nowrap;justify-content:space-between}}.home-customers__text-wrapper{margin-right:1rem;width:33%}@media(max-width:767px){.home-customers__text-wrapper{text-align:center;width:100%}}.home-customers__stat{font-size:2.25rem;margin:0 0 5px}.home-customers__stat-description{font-size:1.125rem;letter-spacing:.02rem;margin-top:0}@media(min-width:768px){.home-customers__stat-description{margin-bottom:0}}.home-customers__logos-grid{align-items:center;display:flex;flex-flow:row wrap;justify-content:center}@media(min-width:768px){.home-customers__logos-grid{max-width:600px}}.home-customers__logo{max-height:100%;width:100%}.home-customers__logo-wrapper{flex:1 1 50%;padding:20px;text-align:center}@media(min-width:501px){.home-customers__logo-wrapper{flex:1 1 25%}}.convert-customers .home-customers{padding:3em 0}.convert-customers .home-customers__content-wrapper{flex-flow:row wrap}@media(min-width:768px){.convert-customers .home-customers__content-wrapper{flex-flow:column}}.convert-customers .home-customers__text-wrapper{margin:0 auto;max-width:78%;text-align:center}@media(min-width:501px){.convert-customers .home-customers__text-wrapper{max-width:100%;width:100%}}.convert-customers .home-customers__stat{display:none}.convert-customers .home-customers__stat-description{font-size:1.375rem;font-weight:600;margin:2em 0}.convert-customers .home-customers__stat-description strong{font-size:2rem;font-weight:600}.convert-customers .home-customers__logos-grid{max-width:100%}@media(min-width:501px){.convert-customers .home-customers__logos-grid{flex-flow:row}}

  .csol-cta-content-block .csol-cta-content-block-header{font-size:1.5rem;font-weight:500;line-height:1.42}.csol-cta-content-block{padding-left:16px;padding-right:16px;position:relative}.csol-cta-content-block .csol-cta-content-block-container{display:flex;flex-direction:column}@media(min-width:600px){.csol-cta-content-block .csol-cta-content-block-container{align-items:center;flex-direction:row;justify-content:space-between}}.csol-cta-content-block .csol-cta-content-block-image{display:block;margin:0 auto;max-width:300px;order:-1;padding:0 24px}@media(min-width:600px){.csol-cta-content-block .csol-cta-content-block-image{flex:1 0 240px;margin:0;max-width:none;order:1;padding:0;width:240px}}@media(min-width:900px){.csol-cta-content-block .csol-cta-content-block-image{flex:0 1 340px;width:340px}}.csol-cta-content-block .csol-cta-content-block-image img{display:block;width:100%}.csol-cta-content-block .csol-cta-content-block-content{max-width:620px;position:relative}@media(min-width:600px){.csol-cta-content-block .csol-cta-content-block-content{margin-right:25px}}.csol-cta-content-block .csol-cta-content-block-description,.csol-cta-content-block .csol-cta-content-block-header{margin-top:16px}.csol-cta-content-block .csol-cta-content-block-buttons{align-items:flex-start;display:flex;flex-direction:column;justify-content:flex-start;margin-top:24px}@media(min-width:900px){.csol-cta-content-block .csol-cta-content-block-buttons{align-items:center;flex-direction:row}.csol-cta-content-block .csol-cta-content-block-buttons>.csol-cta-content-block-button:first-child{margin-right:24px}}.csol-cta-content-block .csol-cta-content-block-buttons .csol-cta-content-block-button{margin-bottom:16px;text-align:center;width:100%}@media(min-width:600px){.csol-cta-content-block .csol-cta-content-block-buttons .csol-cta-content-block-button{text-align:center;width:auto}}.csol-cta-content-block .csol-cta-content-block-disclaimer{font-size:.875rem;line-height:1.57}
</style>

<style>
.home-products-feature__card--headline{font-size:1.5rem;font-weight:500;line-height:1.42}.home-products-feature__card--heading>a{color:#0b8484;font-weight:500}.home-products-feature__card--heading{font-size:1rem;font-weight:300;line-height:1.75}.cl-button,.home-products-feature__card{border:1px solid;border-radius:3px}.cl-button{cursor:pointer;display:inline-block;font-size:1rem;font-weight:500;text-align:center;text-decoration:none;transition:background-color .15s linear,color .15s linear}.cl-button:focus-visible,.cl-button:hover{text-decoration:none}.cl-button.-disabled,.cl-button:disabled{cursor:not-allowed;opacity:.5}.cl-button.-primary{background-color:#05023a;border-color:transparent;color:#fff}.cl-button.-primary:focus-visible,.cl-button.-primary:hover{background-color:#ffcec2}.cl-button.-primary:active{background-color:#080119}.cl-button.-primary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-primary{background-color:#040131}.high-contrast .cl-button.-primary:focus-visible,.high-contrast .cl-button.-primary:hover{background-color:#cee2ff;color:#0c009e}.cl-button.-primaryDark{background-color:#fff;border-color:transparent;color:#2e475d}.cl-button.-primaryDark:focus-visible,.cl-button.-primaryDark:hover{background-color:#f6f9fc}.cl-button.-primaryDark:active{background-color:#eaf0f6}.cl-button.-primaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-secondary{background-color:#fff;border-color:#ff5c35;color:#ff5c35}.cl-button.-secondary:focus-visible,.cl-button.-secondary:hover{background-color:#ffebe6}.cl-button.-secondary:active{background-color:#ffebe6}.cl-button.-secondary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-secondary{background-color:#edf8ff;border-color:#180bb1;color:#180bb1}.high-contrast .cl-button.-secondary:focus-visible,.high-contrast .cl-button.-secondary:hover{background-color:#caebff;border-color:#180bb1;color:#180bb1}.cl-button.-secondaryDark{background-color:transparent;border-color:#fff;color:#fff}.cl-button.-secondaryDark:focus-visible,.cl-button.-secondaryDark:hover{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:active{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-tertiary{background-color:#3e5974;border-color:#3e5974;color:#fff}.cl-button.-tertiary:focus-visible,.cl-button.-tertiary:hover{background-color:#516f90}.cl-button.-tertiary:active{background-color:#2e475d}.cl-button.-tertiary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.cl-button.-tertiaryDark{background-color:#eaf0f6;border-color:#b6c7d6;color:#516f90}.cl-button.-tertiaryDark:focus-visible,.cl-button.-tertiaryDark:hover{background-color:#f6f9fc;border-color:#b6c7d6}.cl-button.-tertiaryDark:active{background-color:#b6c7d6;border-color:#7691ad}.cl-button.-tertiaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-small{font-size:.875rem;line-height:1.57;padding:.25rem 1rem}.cl-button.-medium,.cl-button.-regular{font-size:1rem;line-height:1.75;padding:.5rem 2rem}.cl-button.-large{font-size:1.125rem;line-height:1.78;padding:1rem 2.5rem}:root{--home-products-feature-icon-color:#ff5c35}.high-contrast{--home-products-feature-icon-color:#1d0cff}.home-growth-stack{padding:4.375rem 0}.home-growth-stack .home-growth-stack__logo-wrapper{margin:0 auto 2rem;max-width:100%;padding:0 2rem;text-align:left;width:802px}@media(min-width:768px){.home-growth-stack .home-growth-stack__logo-wrapper{padding:0}}@media(min-width:1025px){.home-growth-stack .home-growth-stack__logo-wrapper{margin:0 auto 3.5rem}}.home-growth-stack .home-growth-stack__logo-wrapper img{max-width:260px}.home-growth-stack .home-growth-stack__logo-header{margin-bottom:1.25rem;margin-top:0;text-align:left}@media(min-width:768px){.home-growth-stack .home-growth-stack__logo-header{margin-bottom:1.875rem;text-align:center}}.home-growth-stack .home-growth-stack__logo-description{font-size:1rem;margin-bottom:0}@media(min-width:768px){.home-growth-stack .home-growth-stack__logo-description{padding:0 2rem}}.home-growth-stack .home-growth-stack__ctas{margin-top:1.875rem;transition:transform .3s;width:100%}@media(min-width:501px){.home-growth-stack .home-growth-stack__ctas{display:flex;justify-content:center}}@media(min-width:768px){.home-growth-stack .home-growth-stack__ctas{margin-top:1.25rem}}.home-growth-stack .home-growth-stack__ctas a{font-size:.875rem;padding:.4rem 1.7rem;width:100%}@media(min-width:501px){.home-growth-stack .home-growth-stack__ctas a{width:48%}}@media(min-width:768px){.home-growth-stack .home-growth-stack__ctas a{width:auto}}.home-growth-stack .home-growth-stack__ctas .cta--secondary{margin-bottom:.5rem}@media(min-width:501px){.home-growth-stack .home-growth-stack__ctas .cta--primary,.home-growth-stack .home-growth-stack__ctas .cta--secondary{margin:0 .5rem}}.home-growth-stack.home-products-feature-v2 .home-growth-stack__logo-wrapper{padding:0 1rem}@media(min-width:768px){.home-growth-stack.home-products-feature-v2 .home-growth-stack__logo-wrapper{padding:0 1.25rem;width:865px}}@media(min-width:701px)and (max-width:1024px){.home-growth-stack.home-products-feature-v2 .home-growth-stack__logo-header{text-align:center}}.home-growth-stack.home-products-feature-v2 .home-growth-stack__logo-description{text-align:left}@media(min-width:768px){.home-growth-stack.home-products-feature-v2 .home-growth-stack__logo-description{margin-top:2.5rem;padding:0}}@media(max-width:767px){.home-growth-stack.home-products-feature-v2 .home-growth-stack__ctas{flex-direction:column}.home-growth-stack.home-products-feature-v2 .home-growth-stack__ctas a{margin:0 0 1.25rem;width:100%}.home-growth-stack.home-products-feature-v2 .home-growth-stack__ctas a:first-child{margin-bottom:1.25rem}}.home-products-feature{padding:2.75rem 0}@media(min-width:768px){.home-products-feature{padding:8rem 0}}.home-products-feature__container{display:flex;flex-wrap:wrap;gap:1.5rem}@media(min-width:501px)and (max-width:1024px){.home-products-feature-v2 .home-products-feature__container{padding-top:1.75rem}}.home-products-feature__card{backface-visibility:hidden;background:#fff;border-width:0;box-shadow:0 0 11px #eaf0f6;cursor:pointer;display:flex;margin-right:0;padding:1rem;position:relative;transition:box-shadow .15s ease-in-out,transform .15s ease-in-out;transition:.3s ease-in-out;width:100%}.home-products-feature__card:hover{box-shadow:0 10px 50px -5px rgba(46,71,93,.12);transform:scale(1.014)}.home-products-feature__card--heading{margin-bottom:1em;margin-top:1em}.home-products-feature-v2 .home-products-feature__card{text-align:left;width:calc(50% - 1rem)}@media(max-width:767px){.home-products-feature-v2 .home-products-feature__card{padding:2rem 1.5rem;width:100%}}@media(min-width:501px)and (max-width:1024px){.home-products-feature__card{padding:2rem 2rem 2.3rem}}@media(min-width:768px){.home-products-feature__card{width:49%}}@media(min-width:1025px){.home-products-feature__card{padding:2rem 4.5rem 2.3rem}.home-products-feature-v2 .home-products-feature__card{padding:2rem;width:calc(33% - 1rem)}}.home-products-feature__card:hover{cursor:auto}.home-products-feature__card--text-wrapper{display:flex;flex-direction:column}.home-products-feature__card--content{display:flex;flex-direction:column;flex-grow:1}.home-products-feature__card--content .home-products-feature__features{margin-top:auto}.home-products-feature-v2 .home-products-feature__card--content .home-products-feature__features{border-top:1px solid #b6c7d6}.home-products-feature__card--image{display:inline-block;height:1.5rem;margin-right:.625rem;width:1.5rem}.home-products-feature__card--image-wrapper{align-items:center;display:flex}@media(min-width:1025px){.home-products-feature__card--image-wrapper{justify-content:center}.home-products-feature-v2 .home-products-feature__card--image-wrapper{justify-content:flex-start}}.home-products-feature__card--headline.registered-trademark:after,.home-products-feature__card--headline.trademark:after{font-size:1.625rem;font-weight:300}.home-products-feature__card--headline.trademark:after{content:"â„¢"}.home-products-feature__card--headline.registered-trademark:after{content:"Â®"}.home-products-feature__card.full-width-card{width:100%}@media(min-width:701px){.home-products-feature__card.full-width-card{width:48%}}@media(min-width:1025px){.home-products-feature__card.full-width-card{width:66%}}.home-products-feature__card.full-width-card .home-products-feature__card--text-wrapper{width:100%}@media(min-width:1025px){.home-products-feature__card.full-width-card .home-products-feature__card--list{align-items:flex-start;display:flex;justify-content:space-between}}.home-products-feature__card.full-width-card .home-products-feature__card--list a{margin-top:1rem;width:100%}@media(min-width:1025px){.home-products-feature__card.full-width-card .home-products-feature__card--list a{margin-top:0;width:15rem}.home-products-feature__card.full-width-card .home-products-feature__features ul li{float:left}}.home-products-feature__card.full-width-card .home-products-feature__features ul li .cl-icon{display:inline-block;height:1.35rem;margin-right:.375rem;position:relative;top:6px;width:1.35rem}.home-products-feature__card.full-width-card .home-products-feature__features ul li .cl-icon [href="#check-circle"]{fill:var(--home-products-feature-icon-color)}@media(min-width:1025px){.home-products-feature__card.full-width-card .home-products-feature__features p{border-top:0;padding-top:0;text-align:left}}.home-products-feature__card.full-width-card .home-products-feature__features p:after{content:none}@media(min-width:1025px){.home-products-feature__card.full-width-card .home-products-feature__features p:after{border-bottom:1px solid rgba(153,175,196,.2);content:"";height:.3125rem;margin-left:.625rem;position:absolute;top:4px;width:100%}}.home-products-feature__card--content-description{font-size:.875rem;text-align:left}@media(min-width:1025px){.home-products-feature__card--content-description{text-align:center}}.home-products-feature-v2 .home-products-feature__card--content-description{padding-bottom:1.5rem;text-align:left}.home-products-feature__cta{display:block;padding-top:1.25rem;text-align:center;transition:transform .3s}@media(min-width:768px){.home-products-feature__cta{clear:both}}.home-products-feature__cta a{font-size:.875rem;padding:.4rem 1.7rem;width:100%}@media(min-width:1025px){.home-products-feature__cta a{width:auto}.home-products-feature-v2 .home-products-feature__cta a{width:100%}}.home-products-feature-v2 .home-products-feature__cta a{font-size:1rem;padding-bottom:.45em;padding-left:inherit;padding-right:inherit;padding-top:.45em}.home-products-feature__features--title{border-top:1px solid rgba(153,175,196,.2);font-size:.875rem;font-weight:600;margin-bottom:.94rem;margin-top:2rem;overflow:hidden;padding-top:2rem;position:relative;text-align:left;text-transform:uppercase;z-index:1}.home-products-feature__features ul li{font-size:.75rem;font-weight:500;margin-bottom:.3125rem}.home-products-feature__features ul li:not(:last-child){margin-right:1.25rem}.home-products-feature__features ul li .cl-icon{display:inline-block;height:1.35rem;margin-right:.375rem;position:relative;top:6px;width:1.35rem}.home-products-feature__features ul li .cl-icon [href="#check-circle"]{fill:var(--home-products-feature-icon-color)}

.cl-card{background-color:#fff;border-radius:3px;box-shadow:0 1px 5px rgba(33,51,67,.12);position:relative}.cl-card:after{border-radius:3px;box-shadow:0 8px 16px rgba(33,51,67,.08);content:"";height:100%;left:0;opacity:0;position:absolute;top:0;transition:opacity .3s ease-in-out;width:100%;z-index:-1}.cl-card.-white{background-color:#fff}.cl-card.-light{background-color:#f6f9fc}.cl-card.-dark{background-color:#2e475d}.cl-card.-border{border:1px solid #b6c7d6}.cl-card.-border.-dark{border:none}.cl-card.-edge-left{position:relative}.cl-card.-edge-left:before{border-bottom-left-radius:inherit;border-top-left-radius:inherit;content:"";display:block;height:100%;left:-1px;position:absolute;top:0;width:12px}.cl-card.-edge-left.-border:not(.-dark):before{height:calc(100% + 2px);top:-1px}.cl-card.-edge-top{position:relative}.cl-card.-edge-top:before{border-top-left-radius:inherit;border-top-right-radius:inherit;content:"";display:block;height:13px;left:0;position:absolute;top:-1px;width:100%}.cl-card.-edge-top.-border:not(.-dark):before{left:-1px;width:calc(100% + 2px)}.cl-card.-edge-left.-green:before,.cl-card.-edge-left.-oz:before,.cl-card.-edge-top.-green:before,.cl-card.-edge-top.-oz:before{background:#4fb06d}.cl-card.-edge-left.-green.-dark:before,.cl-card.-edge-left.-oz.-dark:before,.cl-card.-edge-top.-green.-dark:before,.cl-card.-edge-top.-oz.-dark:before{background:#cae7d3}.cl-card.-edge-left.-lorax:before,.cl-card.-edge-left.-tangerine:before,.cl-card.-edge-top.-lorax:before,.cl-card.-edge-top.-tangerine:before{background:#ff5c35}.cl-card.-edge-left.-lorax.-dark:before,.cl-card.-edge-left.-tangerine.-dark:before,.cl-card.-edge-top.-lorax.-dark:before,.cl-card.-edge-top.-tangerine.-dark:before{background:#ffcec2}.cl-card.-edge-left.-calypso:before,.cl-card.-edge-left.-teal:before,.cl-card.-edge-top.-calypso:before,.cl-card.-edge-top.-teal:before{background:#0fbfbf}.cl-card.-edge-left.-calypso.-dark:before,.cl-card.-edge-left.-teal.-dark:before,.cl-card.-edge-top.-calypso.-dark:before,.cl-card.-edge-top.-teal.-dark:before{background:#b7ecec}.cl-card.-edge-left.-marigold:before,.cl-card.-edge-left.-yellow:before,.cl-card.-edge-top.-marigold:before,.cl-card.-edge-top.-yellow:before{background:#ffbc4b}.cl-card.-edge-left.-marigold.-dark:before,.cl-card.-edge-left.-yellow.-dark:before,.cl-card.-edge-top.-marigold.-dark:before,.cl-card.-edge-top.-yellow.-dark:before{background:#ffebc9}.cl-card.-hoverable{transition:opacity .3s ease-in-out}.cl-card.-hoverable:hover{cursor:pointer}.cl-card.-hoverable:hover:after{opacity:1}

.csol-full-width-cta-card-caption,.csol-full-width-cta-card-header{font-size:1.125rem;font-weight:600;line-height:1.56}.csol-full-width-cta-card-description>a,.csol-full-width-cta-card-disclaimer>a{color:#0b8484;font-weight:500}.csol-full-width-cta-card-description,.csol-full-width-cta-card-disclaimer{font-size:1rem;font-weight:300;line-height:1.75}.cl-button{border:1px solid;border-radius:3px;cursor:pointer;display:inline-block;font-size:1rem;font-weight:500;text-align:center;text-decoration:none;transition:background-color .15s linear,color .15s linear}.cl-button:focus-visible,.cl-button:hover{text-decoration:none}.cl-button.-disabled,.cl-button:disabled{cursor:not-allowed;opacity:.5}.cl-button.-primary{background-color:#020439;border-color:transparent;color:#fff}.cl-button.-primary:focus-visible,.cl-button.-primary:hover{background-color:#ffcec2}.cl-button.-primary:active{background-color:#d44325}.cl-button.-primary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-primary{background-color:#1d0cff}.high-contrast .cl-button.-primary:focus-visible,.high-contrast .cl-button.-primary:hover{background-color:#cee2ff;color:#0c009e}.cl-button.-primaryDark{background-color:#fff;border-color:transparent;color:#2e475d}.cl-button.-primaryDark:focus-visible,.cl-button.-primaryDark:hover{background-color:#f6f9fc}.cl-button.-primaryDark:active{background-color:#eaf0f6}.cl-button.-primaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-secondary{background-color:#fff;border-color:#070144;color:#130149}.cl-button.-secondary:focus-visible,.cl-button.-secondary:hover{background-color:#ffebe6}.cl-button.-secondary:active{background-color:#ffebe6}.cl-button.-secondary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-secondary{background-color:#edf8ff;border-color:#180bb1;color:#180bb1}.high-contrast .cl-button.-secondary:focus-visible,.high-contrast .cl-button.-secondary:hover{background-color:#caebff;border-color:#180bb1;color:#180bb1}.cl-button.-secondaryDark{background-color:transparent;border-color:#fff;color:#fff}.cl-button.-secondaryDark:focus-visible,.cl-button.-secondaryDark:hover{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:active{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-tertiary{background-color:#3e5974;border-color:#3e5974;color:#fff}.cl-button.-tertiary:focus-visible,.cl-button.-tertiary:hover{background-color:#516f90}.cl-button.-tertiary:active{background-color:#2e475d}.cl-button.-tertiary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.cl-button.-tertiaryDark{background-color:#eaf0f6;border-color:#b6c7d6;color:#516f90}.cl-button.-tertiaryDark:focus-visible,.cl-button.-tertiaryDark:hover{background-color:#f6f9fc;border-color:#b6c7d6}.cl-button.-tertiaryDark:active{background-color:#b6c7d6;border-color:#7691ad}.cl-button.-tertiaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-small{font-size:.875rem;line-height:1.57;padding:.25rem 1rem}.cl-button.-medium,.cl-button.-regular{font-size:1rem;line-height:1.75;padding:.5rem 2rem}.cl-button.-large{font-size:1.125rem;line-height:1.78;padding:1rem 2.5rem}.csol-full-width-cta-card{padding:0 16px}@media(min-width:1080px){.csol-full-width-cta-card{padding:0}}.csol-full-width-cta-card-caption{color:#fff;margin:0;text-align:center}.csol-full-width-cta-card-container{display:flex;flex-direction:column}@media(min-width:600px){.csol-full-width-cta-card-container{flex-direction:row;justify-content:flex-end}.csol-full-width-cta-card-container.-right{flex-direction:row-reverse}}.csol-full-width-cta-card-cta{margin-top:40px}.csol-full-width-cta-card-content{color:#2e475d;flex-grow:1;padding:40px}.csol-full-width-cta-card-header{margin:0 0 16px}.csol-full-width-cta-card-description{margin:16px 0}.csol-full-width-cta-card-disclaimer{display:block;margin-top:16px}.csol-full-width-cta-card-image{background-image:linear-gradient(90deg,#ff5c35 0,#ff8933);box-sizing:content-box;flex-grow:0;min-height:100%;overflow:hidden;position:relative}.high-contrast .csol-full-width-cta-card-image{background:#2e475d}@media(min-width:600px){.csol-full-width-cta-card-image{min-width:184px;width:184px}}@media(min-width:900px){.csol-full-width-cta-card-image{min-width:339px;width:339px}}.csol-full-width-cta-card-background{height:100%;left:0;position:absolute;top:0;width:100%;z-index:1}.csol-full-width-cta-card-background-image{height:100%;object-fit:cover;width:100%}.csol-full-width-cta-card-overlay{background-color:#2e475d;inset:0;object-fit:cover;opacity:.8;position:absolute;z-index:2}.csol-full-width-cta-card-hubspot-logo+.csol-full-width-cta-card-caption{margin-top:16px}.csol-full-width-cta-card-graphic-container{align-items:center;display:flex;flex-direction:column;height:100%;justify-content:center;overflow:hidden;padding:40px;position:relative;width:100%;z-index:3}.csol-full-width-cta-card-graphic-container:empty{min-height:336px}@media(min-width:600px){.csol-full-width-cta-card-graphic-container:empty{min-height:auto}}.csol-full-width-cta-card-graphic-container.-mobile-hide{display:none}@media(min-width:600px){.csol-full-width-cta-card-graphic-container.-mobile-hide{display:block}}

.csol-section{padding-bottom:32px;padding-top:32px}@media(min-width:600px){.csol-section{padding-bottom:48px;padding-top:48px}}.csol-section.-padding-top-xs{padding-top:16px}@media(min-width:600px){.csol-section.-padding-top-xs{padding-top:24px}}.csol-section.-padding-top-none{padding-top:0}.csol-section.-padding-top-s{padding-top:24px}@media(min-width:600px){.csol-section.-padding-top-s{padding-top:40px}}.csol-section.-padding-top-md{padding-top:40px}@media(min-width:600px){.csol-section.-padding-top-md{padding-top:64px}}.csol-section.-padding-top-lg{padding-top:64px}@media(min-width:600px){.csol-section.-padding-top-lg{padding-top:96px}}.csol-section.-padding-bottom-xs{padding-bottom:16px}@media(min-width:600px){.csol-section.-padding-bottom-xs{padding-bottom:24px}}.csol-section.-padding-bottom-none{padding-bottom:0}.csol-section.-padding-bottom-s{padding-bottom:24px}@media(min-width:600px){.csol-section.-padding-bottom-s{padding-bottom:40px}}.csol-section.-padding-bottom-md{padding-bottom:40px}@media(min-width:600px){.csol-section.-padding-bottom-md{padding-bottom:64px}}.csol-section.-padding-bottom-lg{padding-bottom:64px}@media(min-width:600px){.csol-section.-padding-bottom-lg{padding-bottom:96px}}.csol-section.-white{background-color:#fff;color:#2e475d}.csol-section.-light{background-color:#f6f9fc;color:#2e475d}.csol-section.-dark{background-color:#3e5974;color:#fff}.csol-section-wrapper{margin:0 auto;max-width:1080px;width:100%}
.cl-button{border:1px solid;border-radius:3px;cursor:pointer;display:inline-block;font-size:1rem;font-weight:500;text-align:center;text-decoration:none;transition:background-color .15s linear,color .15s linear}.cl-button:focus-visible,.cl-button:hover{text-decoration:none}.cl-button.-disabled,.cl-button:disabled{cursor:not-allowed;opacity:.5}.cl-button.-primary{background-color:#040238;border-color:transparent;color:#fff}.cl-button.-primary:focus-visible,.cl-button.-primary:hover{background-color:#ffcec2}.cl-button.-primary:active{background-color:#020127}.cl-button.-primary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-primary{background-color:#1d0cff}.high-contrast .cl-button.-primary:focus-visible,.high-contrast .cl-button.-primary:hover{background-color:#cee2ff;color:#0c009e}.cl-button.-primaryDark{background-color:#fff;border-color:transparent;color:#2e475d}.cl-button.-primaryDark:focus-visible,.cl-button.-primaryDark:hover{background-color:#f6f9fc}.cl-button.-primaryDark:active{background-color:#eaf0f6}.cl-button.-primaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-secondary{background-color:#fff;border-color:#ff5c35;color:#ff5c35}.cl-button.-secondary:focus-visible,.cl-button.-secondary:hover{background-color:#ffebe6}.cl-button.-secondary:active{background-color:#ffebe6}.cl-button.-secondary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.high-contrast .cl-button.-secondary{background-color:#edf8ff;border-color:#180bb1;color:#180bb1}.high-contrast .cl-button.-secondary:focus-visible,.high-contrast .cl-button.-secondary:hover{background-color:#caebff;border-color:#180bb1;color:#04012a}.cl-button.-secondaryDark{background-color:transparent;border-color:#fff;color:#fff}.cl-button.-secondaryDark:focus-visible,.cl-button.-secondaryDark:hover{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:active{background-color:#fff;color:#2e475d}.cl-button.-secondaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-tertiary{background-color:#3e5974;border-color:#3e5974;color:#fff}.cl-button.-tertiary:focus-visible,.cl-button.-tertiary:hover{background-color:#516f90}.cl-button.-tertiary:active{background-color:#2e475d}.cl-button.-tertiary:focus-visible{outline:2px solid #0b8484;outline-offset:2px}.cl-button.-tertiaryDark{background-color:#eaf0f6;border-color:#b6c7d6;color:#516f90}.cl-button.-tertiaryDark:focus-visible,.cl-button.-tertiaryDark:hover{background-color:#f6f9fc;border-color:#b6c7d6}.cl-button.-tertiaryDark:active{background-color:#b6c7d6;border-color:#7691ad}.cl-button.-tertiaryDark:focus-visible{outline:2px solid #b7ecec;outline-offset:2px}.cl-button.-small{font-size:.875rem;line-height:1.57;padding:.25rem 1rem}.cl-button.-medium,.cl-button.-regular{font-size:1rem;line-height:1.75;padding:.5rem 2rem}.cl-button.-large{font-size:1.125rem;line-height:1.78;padding:1rem 2.5rem}
</style>
...
<div class="body-container-wrapper   hs-content-id-7258165248 hs-site-page page hs-content-path- hs-content-name-hubspot-academy-home  ">
...
<div class="academy-typing-hero__content">
  <div class="academy-typing-hero__content--typing-effect">
    <div class="academy-typing-hero__content--animation">
      
        <button class="academy-typing-hero__content--animation-button pause-play-animation">
          <img src="https://academy.hubspot.com/hubfs/assets/academy/pause-icon.svg" alt="pause animation" data-pausetext="pause animation" data-playtext="play animation">
        </button>
        <button class="academy-typing-hero__content--animation-button stop-animation">
          <img src="https://academy.hubspot.com/hubfs/assets/academy/stop-icon.svg" alt="stop animation">
        </button>
...
<div class="section-header">
  ...
  <div id="hs_cos_wrapper_module_159838342688331" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">





<section class="hsg-multi-col" data-background="off-white" >
...
<div id="hs_cos_wrapper_module_1550240577063586" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
...
<footer class="academy-footer hsg-footer" style="background: rgb(1, 1, 33);">
  ...
  <ul>
    ...
    <li class="hsg-footer__nav-column">
      ...
      <ul class="hsg-footer__nav-list">
        ...
        <li class="hsg-footer__nav-item">
          <a href="">Industry Benchmark Data</a>
        </li>
    ...
    <li class="hsg-footer__nav-column">
      <h2 class="hsg-footer__nav-heading">
        <button class="hsg-footer__nav-toggle" tabindex="-1" aria-disabled="true">
          Management Team<i class="hsg-footer__nav-toggle-icon" aria-hidden="true"></i>
        </button>
      </h2>
      ...
      <ul class="hsg-footer__nav-list">
        ...
        <li class="hsg-footer__nav-item">
          <a href="">Dast Tech Partners</a>
        </li>
        
        <li class="hsg-footer__nav-item">
          <a href="">Join our Telegram Group</a>
        </li>
    ...
    <li class="hsg-footer__nav-item--contact-links">
      ...
      <div class="hsg-footer__cta">
        <a href="" target="_blank" class="cta cta--primary cta--small">Dast Tech Support</a>
      </div>
      ...
      <ul class="hsg-footer__social">
        ...
        <li>
          <a href="" target="_blank">
            <i class="hsg-icon hsg-icon-twitter" aria-hidden="true"></i>
...
<section class="hsg-footer__contact-links">
  ...
  <div class="hsg-footer__cta">
    <a href="" target="_blank" class="cta cta--primary-light cta--small">Dast Tech Support</a>
  </div>
...
<section class="hsg-footer__languages">
  <ul>
    ...
    <li>
      <a lang="de" href="">Deutsch</a>
    </li>
    
    <li>
      <a lang="ja" href="">日本語</a>
    </li>
...
<script src="https://academy.hubspot.com/hs-fs/hub/53/hub_generated/template_assets/40719914369/1666086730188/_Web_Team_Assets/Academy/chunks/vendors.min.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>
<script src="https://academy.hubspot.com/hs-fs/hub/53/hub_generated/template_assets/40719914360/1666086723354/_Web_Team_Assets/Academy/app/global.min.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>
</div>

<script src="https://polyfill.io/v3/polyfill.min.js?flags=gated%2Cfeatures=Array.prototype.find%2CArray.prototype.includes" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>


  <script type="application/json" id="deferred-scripts" nonce="iBMh0aTZcFEtM9In4qQSvg==">
{
"deferredScripts": [{
    "id": "hs-script-loader",
...
<script id="wt-script-loader" nonce="iBMh0aTZcFEtM9In4qQSvg==">
...
<script type="text/javascript" async src="https://play.vidyard.com/embed/v4.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>
<script src="https://academy.hubspot.com/hs-fs/hub/53/hub_generated/template_assets/34195414920/1677774138796/_Web_Team_Assets/Academy/app/home.min.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>



<!-- HubSpot performance collection script -->
<script defer src="https://static.hsappstatic.net/content-cwv-embed/static-1.194/embed.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>
<script nonce="iBMh0aTZcFEtM9In4qQSvg==">
var hsVars = hsVars || {}; hsVars['language'] = 'en';
</script>

<script src="/hs/hsstatic/cos-i18n/static-1.53/bundles/project.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>


<!-- Start of HubSpot Analytics Code -->
<script type="text/javascript" nonce="iBMh0aTZcFEtM9In4qQSvg==">
var _hsq = _hsq || [];
_hsq.push(["setContentType", "standard-page"]);
_hsq.push(["setCanonicalUrl", "https:\/\/academy.hubspot.com"]);
_hsq.push(["setPageId", "7258165248"]);
_hsq.push(["setContentMetadata", {
"contentPageId": 7258165248,
"legacyPageId": "7258165248",
"contentFolderId": null,
"contentGroupId": null,
"abTestId": null,
"languageVariantId": 7258165248,
"languageCode": "en",
...
<script type="text/javascript" nonce="iBMh0aTZcFEtM9In4qQSvg==">
var hsVars = {
render_id: "33c3b7f3-ba3e-4f98-8d3f-d56c3273af14",
ticks: 1684250335498,
page_id: 7258165248,
...
<script defer src="/hs/hsstatic/HubspotToolsMenu/static-1.191/js/index.js" nonce="iBMh0aTZcFEtM9In4qQSvg=="></script>
