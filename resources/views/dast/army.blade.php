  ...
  <section class="hsg-fixed-secondary" data-auto-links="false" data-fixed-element="target">
    <div class="hsg-fixed-secondary__layout">
      ...
      <li role="none" class="hsg-fixed-secondary__nav-item--primary active" data-children="false">
          ...
          <a style="font-size: small;" role="menuitem" id="secondary-nav-hubspot-services"  aria-haspopup="false">
      ...
      <li role="none" class="hsg-fixed-secondary__nav-item--primary" data-children="true">
          ...
          <a style="font-size: small; role="menuitem" id="secondary-nav-onboarding" aria-controls="sub-menu-onboarding" aria-expanded="false" aria-haspopup="true">
            Valuable Networking:
          </a>
          ...
          <ul class="hsg-fixed-secondary__subnav" role="menu" id="sub-menu-onboarding" aria-labelledby="secondary-nav-onboarding" aria-hidden="true">
              ...
              <li role="none" class="hsg-fixed-secondary__nav-item--secondary" data-root="true">
                <a style="font-size: small; role="menuitem" aria-haspopup="false" >Drive Change</a>
              </li>
              <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a style="font-size: small; role="menuitem" aria-haspopup="false" >Recognition and Rewards</a>
              </li>
            <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a style="font-size: small; role="menuitem" aria-haspopup="false" >Innovate and Create</a>
              </li>
            <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a style="font-size: small; role="menuitem" aria-haspopup="false" >Make a Difference</a>
              </li>
      ...
      <li role="none" class="hsg-fixed-secondary__nav-item--primary" data-children="true">
          ...
          <a role="menuitem" id="secondary-nav-professional-services"  aria-controls="sub-menu-professional-services" aria-expanded="false" aria-haspopup="true">
            Qualifications
          </a>
          ...
          <ul class="hsg-fixed-secondary__subnav" role="menu" id="sub-menu-professional-services" aria-labelledby="secondary-nav-professional-services" aria-hidden="true">
              ...
              <li role="none" class="hsg-fixed-secondary__nav-item--secondary" data-root="true">
                <a role="menuitem" aria-haspopup="false" >  Qualifications</a>
              </li>
              <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a role="menuitem" aria-haspopup="false" >Strong communication and collaboration skills</a>
              </li>
            <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a role="menuitem" aria-haspopup="false" >Proactive and resourceful mindset</a>
              </li>
            <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a role="menuitem" aria-haspopup="false" >Customer Training</a>
              </li>
            <li role="none" class="hsg-fixed-secondary__nav-item--secondary ">
                <a role="menuitem" aria-haspopup="false" >Ability to contribute ideas and execute projects
                </a>
              </li>
            </ul>
          </li>
    ...
    <div class="hsg-full-width-cta-card__card" data-alignment="left">
      <div class="hsg-full-width-cta-card__product">
        <div style="background: rgb(0, 0, 50);" class="hsg-full-width-cta-card__product-text">
          ...
          <img width="80%" style="border-radius: 100%;"  src="{{ asset('/images/IMG-20230529-WA0010.jpg') }}" alt="DAST ARMY">
...
<section class="section-header section-header--one" data-background="white">
  
  <img width="20%" style="height: 100%;"  src="{{ asset('/images/IMG-20230529-WA0010.jpg') }}" alt="DAST ARMY">
  <div class="hsg-page-width-normal">
...
<section class="section-header" data-background="white"><div class="hsg-page-width-normal">
    ...
    <p>Make a Difference: Be part of a movement that will redefine the Web3 landscape. Your efforts will contribute to the growth and development of the industry, leaving a lasting legacy <a href="https://docs.google.com/forms/d/10Db7ENBb10-vW5nvUal8VIv7wCokDYtOmAiT3K0o68Q/edit">Apply Now.</a></p>
      </div>
</section>
</div></span>
</div><!--end widget-span -->
